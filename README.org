...
=scripts can be adjusted for any sample size=
1. [[https://github.com/neocruiser/pipelines/blob/master/r/affymetrix.h4h.pbs][Microarray sample preprocessing and automation]] in bash (Bassim 2018)
2. [[https://github.com/neocruiser/pipelines/blob/master/r/affymetrix.2.0.R][Microarray normalization and expression analyses]] in R (Bassim 2018)
   - Various descriptive plotting
   - Feature selection
   - Data metrics (adjusted variance, means)
   - Subsampling
   - Data fitting with Bayes linear models (B-stats, folds, pvals, averages)
3. [[https://github.com/neocruiser/pipelines/blob/master/r/affymetrix.summary.h4h.sh][Automation to create summary report of all expression analyses]] in
   bash (Bassim 2018)
   - Iterative logging over data fitting
   - Performance metrics (adjusted values, pvals)
4. [[https://github.com/neocruiser/pipelines/blob/master/r/weighted.nets.h4h.pbs][Clustering and network automation]] in bash (Bassim 2018)
   ...
   - Combining models and filtering
5. [[https://github.com/neocruiser/pipelines/blob/master/r/weighted.nets.affymetrix.R][Network
   ...
   - Clustering
   - Logging and iterative performance testing
6. [[https://github.com/neocruiser/pipelines/blob/master/r/heatmaps.3.0.R][Clustering automation with different expression aggregation methods
   ...
   - Model training and module allocations
   - Bootstrapping and model alpha adjustments
   - Various descriptive plotting
   - Iterative testing across methods
7. [[https://github.com/neocruiser/pipelines/blob/master/r/classification.R][Machine learning and deep learning models]] for cancer risk factor
